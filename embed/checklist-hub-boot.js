(function () {
  ...
  function renderHub(data) {
    ...
    html += '<p class="sc-chub-kicker"><span class="sc-chub-kicker-dot" aria-hidden="true"></span>SecurityCipher Resources</p>';
  ...
  function initInteractivity(root) {
    ...
    function updatePanel(cat) {
      ...
      if (cardProg) {
        cardProg.textContent = pct + '% done';
        cardProg.classList.toggle('has-progress', pct > 0);
      }
